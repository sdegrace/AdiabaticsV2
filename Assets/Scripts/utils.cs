...
namespace net.tanngrisnir.stationeers.adiabaticsV2
{
    ...
    public static class utils
    {
        ...
        public static void SetCopyOf<T>(this Component comp, T other) where T : Component
        {
            Type type = comp.GetType();
            // if (type != other.GetType()) return null; // type mis-match
            BindingFlags flags = BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance |
        ...
        // public static void CopyComponent<T>(this GameObject go, T toCopy) where T : Component
        // {
        //     go.GetSetCopyOf(toCopy);
        // }
